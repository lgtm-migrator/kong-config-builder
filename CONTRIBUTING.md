...
* **kong_config_builder Version(s)** - is it a regression?
* **Kongversion in use** - is this a problem with Kong 1.1 only?
...
* Search [GitHub](https://github.com/olxbr/kong-config-builder/pulls) for an open or closed Pull Request that relates to your submission. You don't want to duplicate effort.
